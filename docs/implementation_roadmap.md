...
状態: **M6-A完了(地点1・2、CinderwatchのRoute Graph化)。地点3A/3B以降は未着手**
...
1. 地点3A/3B(物資庫/工兵救出、旧兵舎/伝令路)の分岐実装、Route GraphへBranchGroup/
   条件付きEdgeを追加、キャンプII
2. 地点5(信号塔下層、信号塔Object・副信号機・主信号機)
3. 地点6(最後の信号、元守備隊長ボス)
4. 敵増援と任務AI
5. 加入候補(辺境工兵・伝令騎兵・旗手)と地域完了
6. 灰鉄採石場解放
7. 4〜6周の実戦計測
